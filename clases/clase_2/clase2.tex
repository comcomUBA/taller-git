...
\begin{frame}[t]{Cambiando de rama}
    ...
    \only<3-3>{
        \begin{figure}[ht]
            \begin{center}
                % TODO ver imagen \includegraphics[height=1.6in]{images/checkout-branch-0.png}
            \end{center}
            \caption{}
        \end{figure}
    }
    ...
    \only<4-4>{
        \begin{figure}[ht]
            \begin{center}
                % TODO ver imagen \includegraphics[height=1.6in]{images/checkout-branch-1.png}
            \end{center}
    ...
    \uncover<5-5>{
        \begin{figure}[ht]
            \begin{center}
                % TODO ver imagen \includegraphics[height=1.6in]{images/checkout-branch-2.png}
            \end{center}
...
\begin{frame}[t]{Fusionando ramas}
    ...
    \only<3-3> {
        \begin{figure}[ht]
            \begin{center}
                % TODO \includegraphics[height=1.5in]{images/merge-branch-0.png}
            \end{center}
    ...
    \only<4-4> {
        \begin{figure}[ht]
            \begin{center}
                % TODO \includegraphics[height=1.5in]{images/merge-branch-1.png}
            \end{center}
...
\begin{frame}[t]{¡A practicar!}
    \begin{ejercicio}{Ejercicio de a 2 máquinas (preferiblemente 2 personas): \emoji{alien} y \emoji{alien-monster}}
        \begin{enumerate}\begin{scriptsize}
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-1.png}
                \end{center}
            \end{figure}
            }
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-2.png}
                \end{center}
            \end{figure}
            }
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-3.png}
                \end{center}
            \end{figure}
            }
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-4.png}
                \end{center}
            \end{figure}
            }
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-7.png}
                \end{center}
            \end{figure}
            }
            ...
            \begin{figure}[ht]
                \begin{center}
                    % TODO \includegraphics[height=1.7in]{images/ejercicio-clase2-8.png}
                \end{center}
            \end{figure}
            }
