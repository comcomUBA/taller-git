...
\begin{frame}{Configuraciones iniciales 3/3}
  ...
  \begin{block}{Subiendo la clave a COMCOMHub}
    ...
    \begin{block}{Funcionó?}
        Pueden probar que la clave quedó funcionando usando el siguiente comando: \textit{ssh -p 222 git@ssh.cubawiki.com.ar}. Deberían ver su username de COMCOMHub.
    \end{block}
