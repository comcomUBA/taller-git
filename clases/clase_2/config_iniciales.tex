...
\begin{frame}{Configuraciones iniciales 3/3}
  \begin{block}{Creando una clave nueva}
	...
	\end{block}
  \pause
  \begin{block}{Subiendo la clave a COMCOMHub}
		\begin{itemize}
		\item En la terminal, ejecutamos \textit{cat id\_rsa.pub} y copiamos todo lo que aparezca.
      \item Abrimos COMCOMHub, vamos a Configuración, Claves SSH / GPG, Añadir clave.
      \item Pegamos lo que tenemos copiado en el campo \textit{Contenido}.
		\end{itemize}
	\end{block}
    \pause
    \begin{block}{Funcionó?}
        Pueden probar que la clave quedó funcionando usando el siguiente comando: \textit{ssh -p 4244 git@ssh.cubawiki.com.ar}. Deberían ver su username de COMCOMHub.
    \end{block}
