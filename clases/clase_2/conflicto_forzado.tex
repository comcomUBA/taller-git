...
\begin{frame}[t]{Comentario sobre otros editores...}

    Esto de corregir los conflictos "a mano" viene de estar utilizando \texttt{nano} como editor. Otros editores de código tienen distintas \textit{features}, una de las cuales puede ser interpretar el formato de Git para mostrar los conflictos. Por ejemplo, Visual Studio Code muestra los conflictos con una interfaz gráfica y \textit{botoncitos}.

    \begin{center}
        \includegraphics[height=2in]{images/merge-conflict-vscode.png}
    \end{center}
