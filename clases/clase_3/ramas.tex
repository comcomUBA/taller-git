...
\begin{frame}[t]{¡A practicar!}
    \begin{ejercicio}{Ejercicio de a 2 máquinas (preferiblemente 2 personas): \emoji{alien} y \emoji{alien-monster}}
        \begin{enumerate}\begin{scriptsize}
            \pause
            \item \emoji{alien}: Hacer un \textit{fork} en su cuenta de \href{https://git.cubawiki.com.ar}{COMCOMHub}
            de este repositorio: \url{https://git.cubawiki.com.ar/talleres-comcom/taller-git-ejercicio2}, y darle permiso a \emoji{alien-monster}
            para hacer \textit{push} (por lo menos \textit{Escritura}).
            \pause
            \item \emoji{alien} y \emoji{alien-monster}: Obtener una copia local del repositorio de \emoji{alien} (\textit{git clone ...} y \textit{cd taller-...})
