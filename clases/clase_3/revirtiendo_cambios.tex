...
\begin{enumerate}
    \item Persona 1: Creá un archivo \texitit{.md}, e incluílo en un commit nuevo, con un mensaje poco legible. Luego hagan push.
    \item Persona 2: Creá un archivo \texitit{.txt}, e incluílo en un commit nuevo, con un mensaje poco legible. Luego hagan push.
    \item Persona 1: trarse los cambios de Persona 2.
    \item Persona 2: trarse los cambios de Persona 1.
    \item Persona 1 y Persona 2: Cambienle el texto al commit de la otra persona con uno que se entienda más.
    \pause
    \item Persona 1: creá un archivo .gitignore, y agregá para que se ignoren todos los archivos \texitit{.txt}. 
    \item Persona 2: creá un archivo .gitignore, y agregá para que se ignoren todos los archivos \texitit{.md}. 
    \item Persona 1 y Persona 2: modifiquen los archivos de más arriba. Hagan sus commits, luego ambos pusheen y pullen los cambios del otro.
    ¿Qué paso?
\end{enumerate}
\end{frame}
