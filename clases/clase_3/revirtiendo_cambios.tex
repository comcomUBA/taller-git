...
\begin{frame}{Prueben los comandos que vimos recién}
    ...
    \begin{enumerate}
        ...
        \item \emoji{dog}: Creá un archivo llamado \textit{perrito}, e incluílo en un commit nuevo, con un mensaje poco legible.
        \item \emoji{cat}: Creá un archivo llamado \textit{gatito}, e incluílo en un commit nuevo, con un mensaje poco legible.
        \item \emoji{dog} y \emoji{cat}: Pushear cambios y traerse los cambios del otro. 
        ...
        \item \emoji{dog} y \emoji{cat}: Hagan push (si tira un mensaje de error prueben hacer \texttt{git push -f}), y vean como cambió su historial de commits tanto en la web como local.
    \end{enumerate}
    \end{ejercicio}
\end{frame}
...
\begin{frame}{Feedback}
    ...
    \begin{block}{¡Nos interesa saber que les pareció el taller!}
        Pueden completar el formulario: \url{https://forms.gle/6BoJUyyUDBMi5Edp8}
