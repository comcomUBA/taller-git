...
\begin{frame}[t]{Preparando cambios}
    ...
    \pause
    \begin{block}{}
        Una vez que tenemos cambios hechos, tenemos que marcarlos como \textit{preparados} (o listos) antes de confirmarlos.
        \begin{enumerate}
...
\begin{frame}[t]{¡A practicar!}
    ...
    \begin{ejercicio}{Ejercicio de a 2 máquinas (preferiblemente 2 personas): 👾 y 👽}
        \begin{enumerate}
            ...
            \pause
            \item 👾: \textit{pushear} los cambios al repositorio remoto.
            \pause
            \item 👽: intentar \textit{pushear} los cambios al repositorio remoto. ¿Qué pasó?
            \pause
