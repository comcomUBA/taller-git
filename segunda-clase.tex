...
\begin{frame}[t]{¡A practicar!}
    \begin{ejercicio}{Ejercicio de a 2 máquinas (preferiblemente 2 personas): 👾 y 👽}
        \begin{enumerate}\begin{scriptsize}
            ...
            de este repositorio: \href{https://www.gitlab.com/talleres-comcom/taller-git-ejercicio2}
            {https://www.gitlab.com/talleres-comcom/taller-git-ejercicio2}, y darle permiso a 👾
            ...
            \pause
            \item 👾: Crear una nueva rama \textbf{a partir de ``master''}, y traerse (\textit{pull})
            a esta rama los cambios de 👽.
            \pause
